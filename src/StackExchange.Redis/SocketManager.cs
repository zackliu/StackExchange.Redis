...
namespace StackExchange.Redis
{
    ...
    public sealed partial class SocketManager : IDisposable
    {
        ...
        private SocketManager(string name, bool useHighPrioritySocketThreads, int workerCount)
        {
            ...
            const long Receive_PauseWriterThreshold = 1L * 1024 * 1024 * 1024; // let's give it up to 1GiB of buffer for now
            const long Receive_ResumeWriterThreshold = 700L * 1024 * 1024;
            const long Send_PauseWriterThreshold = 100L * 1024 * 1024; // 100MB
            const long Send_ResumeWriterThreshold = 60L * 1024 * 1024;
